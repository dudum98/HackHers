...
export declare class Clerk implements ClerkInterface {
    ...
    authenticateWithWeb3: ({ redirectUrl, signUpContinueUrl, customNavigate, unsafeMetadata, strategy, __experimental_legalAccepted, }: ClerkAuthenticateWithWeb3Params) => Promise<void>;
